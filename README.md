...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[4.1 Notes on Data Preparation](#4.1-Notes-on-Data-Preparation)  
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[8.5 Reward](#8.5-Reward)  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[8.6 Custom PPO Hyperparameters](#8.5-Custom-PPO-Hyperparameters)  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[8.7 Current Model Architecture](#8.6-Current-Model-Architecture)  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[8.8 Notes on Environment](#8.7-Notes-on-Environment)  
[9 Analysis of Results](#9-Analysis-of-Results)  
[10 Known Areas of Improvement](#10-Known-Areas-of-Improvement)  
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[A.1 Results of Code Testing Suite](#A.1-Results-of-Code-Testing-Suite)  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[A.2 Notes on Docker Container](#A.2-Notes-on-Docker-Container)
...
***
#### 8.7 Current Model Architecture
***
![alt text](assets/model_diagram.png) 

***
#### 8.8 Notes on Environment
***
...
***
As a preface to this section, please note that the RL model is tested with its exploration configuration turned on. This means that the model's decisions aren't fully deterministic. Please see [10 Known Areas of Improvement](#10-Known-Areas-of-Improvement) for further information.
...
Our next graph shows the agent's performance through its top-performing period in the testing data.
...
The application is designed to run inside a Docker container. Please see section [A.2 Notes on Docker Container](#A.2-Notes-on-Docker-Container) for information on the container's contents. From the top-level directory of the repository, the image can be built by running the following command in a shell:
